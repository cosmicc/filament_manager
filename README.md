...
- Spool entry with unused-spool tare inference, manufacturer/type/capacity-specific empty-weight suggestions, read-only total weight, automatic tare/remaining recalculation that preserves recorded usage, purchase costs, and immutable weigh-in history
