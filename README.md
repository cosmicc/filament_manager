...
- Directly saved `Template <material type>` Cura entries whose changes immediately flow to linked filament profiles except for sparse explicit customizations
