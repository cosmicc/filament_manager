...
- Spool-label tests require high QR error correction, a four-module quiet zone, and the canonical solid, two/three-color, or rainbow palette inside the centered spool icon. Before release, decode representative full-resolution and downscaled label images with an independent scanner.
