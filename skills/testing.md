...
- Filament/spool frontend checks cover live inherited/customized highlighting, Cura-like group placement without a catch-all section, field-specific compact precision, custom solid/multicolor/rainbow swatches, inferred tare preview, full correction forms, color-history locking, and delete-or-archive copy.
