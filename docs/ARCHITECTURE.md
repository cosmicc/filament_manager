...
- directly saved Material Templates, linked sparse product overrides with immutable resolved Material Profile snapshots, revocable Workstation Agents, single-use Pairing Codes, takeover mappings, managed-edit receipts, and immutable desired-library synchronization snapshots
