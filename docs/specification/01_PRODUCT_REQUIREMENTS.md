...
- Import supported Moonraker live/history state and preserve immutable printer, physical spool, product, exact profile, plate, sliced metadata, actual usage, purchase-cost basis, sanitized stored thumbnail, and M600 segment snapshots.
- Show current and historical thumbnails, useful estimated/actual statistics, and exact captured segment-derived filament cost without repricing history from current inventory.
