...
- ignore legacy managed Cura setting edits and reject explicit Cura imports; enforce app-deployed values by known deterministic GUID without trusting mutable Cura containers or local pending receipts
