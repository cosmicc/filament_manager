...
- Cooling: template-only `cool_fan_enabled`, `cool_fan_speed_min`, `cool_fan_speed_max`, `cool_fan_full_layer`, `cool_min_layer_time`, `cool_min_layer_time_fan_speed_max`, and `cool_min_speed`; profile-editable `cool_fan_speed_0`; derived `cool_fan_speed` alias.
