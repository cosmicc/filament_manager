...
- Ironing: `ironing_enabled`, `ironing_flow`, `speed_ironing`, and `ironing_line_spacing` are editable on templates and profiles. Cura 5.13 defines ironing speed as `speed_ironing`; the obsolete `ironing_speed` alias is cleanup-only retired data.
