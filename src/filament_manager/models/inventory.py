...
class Printer(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    spool_preflight_status: Mapped[str] = mapped_column(String(32), nullable=False, default="unknown")
    spool_preflight_message: Mapped[str | None] = mapped_column(String(500))
    last_spool_preflight_sync_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
