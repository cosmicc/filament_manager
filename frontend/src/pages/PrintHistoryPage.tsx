...
import { AlertTriangle, CheckCircle2, ChevronFirst, ChevronLast, ChevronLeft, ChevronRight, Clock3, ExternalLink, FileSearch, History, Printer as PrinterIcon, Rows3, Star } from 'lucide-react'
import { type FormEvent, useMemo, useState } from 'react'
import { actionableApiError, apiFetch } from '../api/client'
import type { Printer, PrintJob, PrintJobPage, PrintQualityRating } from '../api/types'
...
function printOutcomeClass(job: PrintJob) {
