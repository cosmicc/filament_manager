...
const coreComparisonFields: Array<{
  ...
  { key: 'retraction_speed_mm_s', label: 'Retraction retract speed', unit: 'mm/s', valueType: 'number', precision: 0 },
  { key: 'retraction_prime_speed_mm_s', label: 'Retraction prime speed', unit: 'mm/s', valueType: 'number', precision: 0 },
